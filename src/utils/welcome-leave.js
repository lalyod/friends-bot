...
module.exports = async (welcome, member) => {
    ...
    ctx.fillText(welcome ? 'WELCOME' : 'GOOD BYE', canvas.width / 2, canvas.height / 1.35)
    ...
    ctx.fillStyle = '#ffffff'
    ctx.textAlign = 'center'
    ctx.fillText(welcome ? "SELAMAT DATANG " : "SELAMAT TINGGAL " + member.displayName.toUpperCase(), canvas.width / 2, (canvas.height + 130) / 1.35)

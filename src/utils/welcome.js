...
module.exports = async (member, client) => {
    try {
        ...
        ctx.fillText('WELCOME', canvas.width / 2, canvas.height / 1.35)
        ...
        ctx.fillStyle = '#ffffff'
        ctx.textAlign = 'center'
        ctx.fillText(`SELAMAT DATANG ${member.displayName.toUpperCase()}`, canvas.width / 2, (canvas.height + 130) / 1.35)
